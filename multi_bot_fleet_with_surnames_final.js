// multi_bot_fleet_with_surnames_final.js
// Multi-bot fleet script, corrected plugin imports. Should not throw 'plugin needs to be a function'.
...
const HOST = process.env.SERVER_HOST || 'per10.asaka.asia'
const PORT = parseInt(process.env.SERVER_PORT || '30060', 10)
